...
create table public.service_guides (
  ...
  official_url text not null default 'TO_BE_VERIFIED',
...
create table public.official_links (
  ...
  url text not null default 'TO_BE_VERIFIED',
...
insert into public.service_guides (
  ...
  (
    ...
    'Varies by verification and office workload', 'TO_BE_VERIFIED', 'Visit the relevant NIDA office or authorized registration point where applicable.',
  ...
  (
    ...
    'Varies by verification and replacement queue', 'TO_BE_VERIFIED', 'Check the relevant NIDA office or official guidance before visiting.',
  ...
  (
    ...
    'Varies by taxpayer type and verification', 'TO_BE_VERIFIED', 'Use the relevant TRA office or official digital channel where available.',
  ...
  (
    ...
    'Varies by application type and verification', 'TO_BE_VERIFIED', 'Confirm appointment and office requirements through official immigration channels.',
  ...
  (
    ...
    'Varies by channel and verification', 'TO_BE_VERIFIED', 'Confirm whether you need TRA, police, or licensing office steps through official guidance.',
  ...
  (
    ...
    'Varies by record availability and office workload', 'TO_BE_VERIFIED', 'Confirm the relevant civil registration office or official channel.',
  ...
  (
    ...
    'Varies by name availability and verification', 'TO_BE_VERIFIED', 'Use the official BRELA channel or authorized office guidance.',
  ...
  (
    ...
    'Varies by document readiness and verification', 'TO_BE_VERIFIED', 'Use the official BRELA channel or professional guidance where needed.',
  ...
  (
    ...
    'Varies by local authority, sector, and inspection requirements', 'TO_BE_VERIFIED', 'Confirm local government or sector regulator requirements before payment.',
  ...
  (
    ...
    '15-30 minutes to organize reminders', 'TO_BE_VERIFIED', 'Consult TRA or a qualified professional for tax-specific obligations.',
...
insert into public.official_links (guide_id, label_en, label_sw, url, status) values
  ('10000000-0000-4000-8000-000000000001', 'Official portal', 'Tovuti rasmi', 'TO_BE_VERIFIED', 'needs_verification'),
  ('10000000-0000-4000-8000-000000000002', 'Official portal', 'Tovuti rasmi', 'TO_BE_VERIFIED', 'needs_verification'),
  ('10000000-0000-4000-8000-000000000003', 'Official portal', 'Tovuti rasmi', 'TO_BE_VERIFIED', 'needs_verification'),
  ('10000000-0000-4000-8000-000000000004', 'Official portal', 'Tovuti rasmi', 'TO_BE_VERIFIED', 'needs_verification'),
  ('10000000-0000-4000-8000-000000000005', 'Official portal', 'Tovuti rasmi', 'TO_BE_VERIFIED', 'needs_verification'),
  ('10000000-0000-4000-8000-000000000006', 'Official portal', 'Tovuti rasmi', 'TO_BE_VERIFIED', 'needs_verification'),
  ('10000000-0000-4000-8000-000000000007', 'Official portal', 'Tovuti rasmi', 'TO_BE_VERIFIED', 'needs_verification'),
  ('10000000-0000-4000-8000-000000000008', 'Official portal', 'Tovuti rasmi', 'TO_BE_VERIFIED', 'needs_verification'),
  ('10000000-0000-4000-8000-000000000009', 'Official portal', 'Tovuti rasmi', 'TO_BE_VERIFIED', 'needs_verification'),
  ('10000000-0000-4000-8000-000000000010', 'Official portal', 'Tovuti rasmi', 'TO_BE_VERIFIED', 'needs_verification');
